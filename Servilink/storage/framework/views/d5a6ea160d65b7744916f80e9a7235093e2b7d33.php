            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="white-box"
                        ...
                        <h3 class="box-title mname"><?php echo e($mName); ?> Pay In </h3>
                        <ul class="list-inline  two-part">
                            <li><span>₦</span><span class="mpay"><?php echo e($mPayment); ?></span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="white-box"
                        style="border-radius: 20px;padding: 15px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                        <h3 class="box-title mnamer"><?php echo e($mName); ?> Paid Resident</h3>
                        <ul class="list-inline two-part">
                            <li><span class="paidnum"><?php echo e($paidnum); ?></span></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-content"
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="<?php echo e(route('pay.service')); ?>" enctype="multipart/form-data" id="payfee">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="email" type="text"
                                    class="form-control email  <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>" name="email" value=""
                                    readonly >
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">Phone number</label>
                                <input id="phone" type="number"
                                    class="form-control phone  <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
    ...
    <script>
        $(document).ready(function(e) {
            ...
            $(document).on("click", "#search", function(e) {
                ...
                $.ajax({
                    method: 'GET',
                    url: "<?php echo e(route('get.resident')); ?>",
                    data: {
                        queryval:query
                    },
                    success: function(response) {
            ...
            function loadCardDetails() {
                $.ajax({
                    method: "GET",
                    url: "<?php echo e(route('service.stat')); ?>",
                    data: {
            ...
            var tablereport = $("#servicehistory").DataTable({
                ...
                "ordering": false,
                "ajax": {
                    "url": "<?php echo route('service.transaction'); ?>",
                    "data": function(d) {
...
<?php echo $__env->make('layouts.manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ocqv5p3q51h2/Servilink/resources/views/manager/service_charge.blade.php ENDPATH**/ ?>