<?php $__env->startSection('title', 'Residents Management'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('modal.create-user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('modal.edit-user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function(e) {
            ...
            $('#modal-edit-resident').on('show.bs.modal', function(e) {
                ...
                $.ajax({
                    method: 'GET',
                    url: "<?php echo e(route('show.resident')); ?>",
                    data: {
                        id: id,
                    },
                    success: function(response) {
            ...
            var estate_user = $("#estateuser").DataTable({
                ...
                "ordering": false,
                "ajax": {
                    "url": '<?php echo e(route('load.resident')); ?>',
...
<?php echo $__env->make('layouts.manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ocqv5p3q51h2/Servilink/resources/views/manager/residents_manager.blade.php ENDPATH**/ ?>