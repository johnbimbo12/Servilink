...
<head>
    ...
    <title>Servilink |Server Error</title>
    <!-- Bootstrap Core CSS -->
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="<?php echo e(route('welcome')); ?>" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to home</a>
            </div>
...
<?php /**PATH /home/ocqv5p3q51h2/Servilink/resources/views/errors/500.blade.php ENDPATH**/ ?>