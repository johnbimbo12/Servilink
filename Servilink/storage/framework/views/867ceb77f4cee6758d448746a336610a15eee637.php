<?php $__env->startSection('title', 'Estate Security'); ?>
                ...
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="white-box"
                        ...
                        <ul class="list-inline two-part">
                            <li><span class="securitycnt"><?php echo e($cnt); ?></span></li>
                        </ul>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(e) {
            ...
            $('#create-security').submit(function(e) {
                ...
                var url ="<?php echo e(route('store.security')); ?>";
                if($('#data_id').val() !== "0"){
                    url ="<?php echo e(route('edit.security')); ?>";
                }
                $.ajax({
                    method: 'POST',
                    url: url,
            ...
            $(document).on("click", ".edit", function(e) {
                ...
                $.ajax({
                    method: 'GET',
                    url: "<?php echo e(route('show.security')); ?>",
                    data: {
                        id: id,
                    },
                    success: function(response) {
            ...
            $(document).on("click", ".delete", function(e) {
                ...
                if (confirm("Are you sure?")) {
                    $.ajax({
                        url: "<?php echo e(route('delete.security')); ?>",
                        method: 'POST',
                        data: {
                            id: id
                        },
            ...
            var estate_security= $("#estatesecurity").DataTable({
                ...
                "ordering": false,
                "ajax": {
                    "url": "<?php echo e(route('load.security')); ?>",
                },
                dom: 'Blfrtip',
                "pageLength": 50,
                buttons: [
...
<?php echo $__env->make('layouts.manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ocqv5p3q51h2/Servilink/resources/views/manager/security.blade.php ENDPATH**/ ?>