    ...
    <div class="sidebar-nav slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            <?php if(Auth::user()->role == 1): ?>
                <li> <a href="<?php echo e(route('dashboard')); ?>" class="waves-effect"><i class="mdi mdi-home fa-fw"
            ...
            <?php if(Auth::user()->role == 1): ?>
                <li> <a href="<?php echo e(route('managers')); ?>" class="waves-effect"><i
                            class="mdi mdi-account-multiple fa-fw">
                        </i> <span class="hide-menu">Estate Managers
                            <span class="fa arrow"></span></span></a>
                </li>
                <li> <a href="<?php echo e(route('estates')); ?>" class="waves-effect"><i class="mdi mdi-home-map-marker fa-fw">
                        </i> <span class="hide-menu">Registered Estates
                            <span class="fa arrow"></span></span></a>
                </li>
                <li> <a href="<?php echo e(route('power.manage')); ?>" class="waves-effect"><i
            ...
            <?php if(Auth::user()->role == 2 || Auth::user()->role == 3): ?>
                <li> <a href="<?php echo e(route('residents')); ?>" class="waves-effect"><i
                            class="mdi mdi-account-multiple fa-fw">
                        </i> <span class="hide-menu">Residents
                            <span class="fa arrow"></span></span></a>
                </li>
                <li> <a href="<?php echo e(route('manage.estate')); ?>" class="waves-effect"><i
            ...
            <?php if(Auth::user()->role == 2): ?>
                <li> <a href="<?php echo e(route('index.security')); ?>" class="waves-effect"><i
                            class="mdi mdi-security-home fa-fw">
                        </i> <span class="hide-menu">Security
                            <span class="fa arrow"></span></span></a>
                </li>

                <li> <a href="<?php echo e(route('index.space')); ?>" class="waves-effect"><i class="mdi mdi-store fa-fw">
                        </i> <span class="hide-menu">Space Lets
                            <span class="fa arrow"></span></span></a>
                </li>
                <li> <a href="<?php echo e(route('index.booking')); ?>" class="waves-effect"><i class="mdi mdi-cart fa-fw">
                        </i> <span class="hide-menu">Bookings
                            <span class="fa arrow"></span></span></a>
                </li>
            <?php endif; ?>
            <?php if(Auth::user()->role == 2 || Auth::user()->role == 4 || Auth::user()->role == 3): ?>
                <li> <a href="<?php echo e(route('power.manage')); ?>" class="waves-effect"><i
                            class="mdi mdi-lightbulb-on fa-fw"></i> <span class="hide-menu">Power
                            Management<span class="fa arrow"></span></span></a>
                </li>
              
                <li> <a href="<?php echo e(route('visitor.manage')); ?>" class="waves-effect"><i
                            class="mdi mdi-account-switch fa-fw"></i> <span class="hide-menu">Visitor's
                            Management<span class="fa arrow"></span></span></a>
                </li>

                <li> <a href="<?php echo e(route('service.charges')); ?>" class="waves-effect"><i class="mdi mdi-worker fa-fw">
            ...
            <?php if(Auth::user()->role == 4): ?>
                <li> <a href="<?php echo e(route('index.booking')); ?>" class="waves-effect"><i class="mdi mdi-store fa-fw">
                ...
                <li> <a href="<?php echo e(route('transactions')); ?>" class="waves-effect"><i class="mdi mdi-history fa-fw">
            ...
            <?php if(Auth::user()->role == 2 || Auth::user()->role == 4): ?>
                <li> <a href="<?php echo e(route('messaging')); ?>" class="waves-effect">
                        <i class="mdi mdi-wechat fa-fw">
                        </i> <span class="hide-menu">Messaging
                            <span class="fa arrow"></span></span></a>

                </li>
                <li> <a href="<?php echo e(route('emergency')); ?>" class="waves-effect">
            ...
            <?php if(Auth::user()->role == 1): ?>
                <li> <a href="<?php echo e(route('revenue')); ?>" class="waves-effect"><i class="mdi mdi-arrow-compress fa-fw">
                        </i> <span class="hide-menu">Revenue Management
                            <span class="fa arrow"></span></span></a>
                </li>
            <?php endif; ?>
            <?php if(Auth::user()->role == 2 || Auth::user()->role == 3): ?>
                <li> <a href="<?php echo e(route('transactions')); ?>" class="waves-effect"><i
            ...
            <?php if(Auth::user()->role == 3): ?>
                <li> <a href="<?php echo e(route('setting')); ?>" class="waves-effect"><i class="mdi mdi-settings fa-fw">
...
<?php /**PATH /home/ocqv5p3q51h2/Servilink/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>