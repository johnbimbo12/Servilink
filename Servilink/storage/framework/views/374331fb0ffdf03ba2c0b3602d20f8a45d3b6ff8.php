            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="white-box"
                        ...
                        <ul class="list-inline two-part">
                            <li><span class="success_transact"><?php echo e($success); ?></span></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="white-box"
                        ...
                        <ul class="list-inline two-part">
                            <li><span class="fail_transact"><?php echo e($fail); ?></span></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function(e) {
            ...
            var tablehistory = $("#paymenthistory").DataTable({
                ...
                "ordering": false,
                "ajax": {
                    "url": "<?php echo e(route('load.transactions')); ?>",
                    "data": function(d) {
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ocqv5p3q51h2/Servilink/resources/views/resident/transactions_history.blade.php ENDPATH**/ ?>