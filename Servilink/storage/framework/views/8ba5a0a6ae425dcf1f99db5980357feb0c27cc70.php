        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-content"
                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo e(route('purchaseunit')); ?>" enctype="multipart/form-data" id="">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ocqv5p3q51h2/Servilink/resources/views/resident/water_manager.blade.php ENDPATH**/ ?>