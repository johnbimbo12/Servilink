...
<head>
    ...
    <title>Servilink | Access Denied</title>
    <!-- Bootstrap Core CSS -->
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <p class="text-muted m-t-30 m-b-30 text-uppercase">You don't have permission to access on this server.
                </p>
                <a href="{{route('welcome')}}" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to home</a>
            </div>
