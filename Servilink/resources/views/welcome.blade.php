    ...
    <div class="navbar-default navbar-fixed-top" role="navigation" style="">
        <div style="text-align: left; margin-left: 40px">
            ...
            <a class="navbar-brand smoothScroll" href="#top">
                <span class="logo-title"><img src="{{ asset('img/logo.png') }}" width="28px" height="28px"
                        alt="Servilink">
            ...
            @guest
                @if (Route::has('login'))
                    <a class="" href=" {{ route('login') }}">
                        <span class="logo-title" style="color:black;font-size: 18px;">{{ __('Login') }}</span>
                    </a>
                @endif
            @else
                            ...
                            <div class="row" id="main">
                                <div class="col-md-12 col-xs-12 col-sm-12 col-lg-6">
                                    <a class="smoothScroll btn btn-success btn-lg wow fadeInUp"
                                        href="{{ route('instantpay') }}" data-wow-delay="1.2s" data-id="" style="padding-top:20px;padding-bottom: 20px; background: #eebf3f;
                                    border: 1px solid #eebf3f;color: #fff;width: 100%">Residents
                                    </a>
                                </div>
                                <div class="col-md-12 col-xs-12 col-sm-12 col-lg-6">
                                    <a class="smoothScroll btn btn-success btn-lg wow fadeInUp"
                                        href="{{ route('login') }}" data-wow-delay="1.2s" data-id=""
