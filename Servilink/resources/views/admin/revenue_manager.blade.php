                ...
                <div class="col-lg-3 col-sm-6 col-xs-12">
                    <div class="white-box"
                        ...
                        <ul class="list-inline  two-part">
                            <li><span> ₦</span><span class="tincome">{{$tincome}}</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-xs-12">
                    <div class="white-box"
                        ...
                        <ul class="list-inline two-part">
                            <li><span> ₦</span><span class="tmonth">{{$tmonth}}</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-xs-12">
                    <div class="white-box"
                        ...
                        <ul class="list-inline two-part">
                            <li><span> ₦</span><span class="tweek">{{$tweek}}</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-xs-12">
