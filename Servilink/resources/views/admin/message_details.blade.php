                            ...
                            <div class="col-lg-2 col-md-3  col-sm-12 col-xs-12 inbox-panel">
                                <div> 
                                    <div class="list-group mail-list m-t-20"> <a href="{{route('messaging')}}" data-id="0"
                                        ...
                                        <a href="{{route('messaging')}}" class="list-group-item active filter" data-id="2">Pending <span
                                                class="label label-rouded label-warning pull-right">{{ $msgstat['pending'] }}</span></a>
                                        <a href="{{route('messaging')}}" class="list-group-item active filter" data-id="3">Processing <span
                                                class="label label-rouded label-info pull-right">{{ $msgstat['process'] }}</span></a>
                                        <a href="{{route('messaging')}}" class="list-group-item active filter" data-id="1">Resolved <span
                                                class="label label-rouded label-success pull-right">{{ $msgstat['resolved'] }}</span></a>
                                        <a href="{{route('messaging')}}" class="list-group-item active filter" data-id="5">Unread <span
                                                class="label label-rouded label-danger pull-right">{{ $msgstat['unread'] }}</span></a>
                                        <a href="{{route('messaging')}}" class="list-group-item active filter" data-id="4">Read <span
