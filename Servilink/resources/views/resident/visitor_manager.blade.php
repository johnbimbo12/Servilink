...
@section('title', "Visitor's Management")
@section('content')
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12" style="margin-bottom: 0px">
                                ...
                                <div class="input-group date" id="id_1">
                                    <input type="text" name="entrydate" value="{{ $date }}" class="form-control"
                                        required />
                            ...
                            <div class="form-group col-md-12" style="margin-bottom: 0px">
                                ...
                                <div class="input-group date" id="id_2">
                                    <input type="text" name="entrytime" value="{{ $time }}" class="form-control"
                                        required />
                                    <div class="input-group-addon input-group-append">
                                        <div class="input-group-text">
    ...
    <script>
        $(document).ready(function(e) {
            ...
            $('#gentoken').submit(function(e) {
                ...
                $.ajax({
                    method: 'POST',
                    url: '{{ route('generate.visitortoken') }}',
                    data: form,
