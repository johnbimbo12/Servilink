 ...
 @section('title', 'Residents Dashboard')
 @section('content')
     <style>
         .mobile {
             margin-top: 0px;
             ...
             <div class="mobile">
                 ...
                 <div class="row">
                     ...
                     <div class="col-lg-4 col-sm-6 col-xs-12 " id="power">
                         <div class="white-box"
                             style="border-radius: 20px;padding: 15px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                             <a href="{{ route('visitor.manage') }}" class="product">
                 ...
                 <div class="row">
                     ...
                     <div class="col-lg-4 col-sm-6 col-xs-12 " id="power">
                         <div class="white-box"
                             style="border-radius: 20px;padding: 15px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                             <a href="{{ route('service.charges') }}" class="product">
                     ...
                     <div class="col-lg-4 col-sm-6 col-xs-12" id="power">
                         <div class="white-box"
                             style="border-radius: 20px;padding: 15px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                             <a href="{{ route('messaging') }}" class="product">
